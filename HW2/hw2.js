...
function validateEmail2() {
    ...
    if (email == "") {
        document.getElementById("email2-error").innerHTML = "Required, please input Email Adderess";
        dob.value = "";
        return false;
    } else if (!email.match(emailR)){
        document.getElementById("email2-error").innerHTML = "Enter Valid email address";
        return false;
    } else {
